...
class Cliente {
    constructor(idCliente, tipoCliente, dataCliente, codBanco, agencia, conta, saldo) {
...
class PessoaFisica extends Cliente {
    constructor(idCliente, tipoCliente, dataCliente, codBanco, agencia, conta, saldo, nome, cpf, email, telefone, dataDeNascimento) {
        super(idCliente, tipoCliente, dataCliente, codBanco, agencia, conta, saldo)
        this.nome = nome;
        this.cpf = cpf;
        this.email = email;
...
class PessoaJuridica extends Cliente {
    constructor(idCliente, tipoCliente, dataCliente, codBanco, agencia, conta, saldo, nomeFantasia, cnpj, email, telefone, dataDaFundacao) {
        super(idCliente, tipoCliente, dataCliente, codBanco, agencia, conta, saldo)
...
class Transacao {
    static transferencia(contaOrigem, contaDestino, idTransacao, dataDeTransacao, valorDaTransferencia) {
        if(contaOrigem.saldo > contaDestino.saldo) {
